			...
			<table id="tblSocket" width="100%" class="table table-striped table-bordered table-hover table-sm" style="width:100%">
				...
				<tbody>
					...
					<tr>
						...
						<td>{{$serie->series}}</td>
						<td>
							<a href="{{ url('series',[$serie]) }}" class="btn btn-warning"><i class="fa-solid fa-edit"></i></a>
						</td>
						<td>
							<form method="POST" action="{{ url('series',[$serie]) }}">
								@method('delete')
								@csrf
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">NEW SERIE TAG</h5>
				...
				<div class="modal-body">
					<form id="formTag" method="POST" action="{{ url('series') }}">
						@csrf
						<div class="form-group">
							<label for="socket">SERIE</label>
